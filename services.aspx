<%@ Page Title="ETS Networks | Services" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="services.aspx.vb" Inherits="services" %>
...
<p>
<img src="img/services/<%# Eval("pic") %>"  alt ="<%#EVAL("pic") %>" width="400"  style =" border :inset 4px #1d2c53; float:right ;"  />
...
<asp:Label ID="piclbl" runat="server" Text='<%# Eval("pic") %>' Visible ="false"></asp:Label>
<img src="img/services/<%# Eval("pic") %>"   alt ="<%#EVAL("pic") %>" width="400"/>
<br />
...
SelectCommand="SELECT * FROM [services]"
 UpdateCommand ="UPDATE services set body=@body, pic=@pic, keywords=@keywords, title=@title WHERE [key]=@key">
  <UpdateParameters>
