...
<h2>Welcome To ETS Networks! </h2>
<h3>IT Support For Asheville/Hendersonville, NC</h3> 
...
<p>
<img src="img/home/<%# Eval("pic") %>"  alt ="<%#EVAL("pic") %>" width="400"  style =" border :inset 4px #1d2c53; float:right ;"  />
...
<asp:Label ID="piclbl" runat="server" Text='<%# Eval("pic") %>' Visible ="false"></asp:Label>
<img src="img/home/<%# Eval("pic") %>"   alt ="<%#EVAL("pic") %>" width="400"/>
<br />
...
SelectCommand="SELECT * FROM [home]"
 UpdateCommand ="UPDATE home set body=@body, pic=@pic, keywords=@keywords, title=@title WHERE [key]=@key">
  <UpdateParameters>
