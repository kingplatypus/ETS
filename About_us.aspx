<%@ Page Title="ETS Networks | About Us" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="About_us.aspx.vb" Inherits="About_us" %>
...
<p>
<img src="img/about/<%# Eval("pic") %>"  alt ="<%#EVAL("pic") %>" width="400"  style =" border :inset 4px #1d2c53; float:right ;"  />
...
<asp:Label ID="piclbl" runat="server" Text='<%# Eval("pic") %>' Visible ="false"></asp:Label>
<img src="img/about/<%# Eval("pic") %>"   alt ="<%#EVAL("pic") %>" width="400"/>
<br />
...
SelectCommand="SELECT * FROM [about]"
 UpdateCommand ="UPDATE about set body=@body, pic=@pic, keywords=@keywords, title=@title WHERE [key]=@key">
  <UpdateParameters>
