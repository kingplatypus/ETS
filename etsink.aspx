<%@ Page Title="ETS Networks | Ink" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="etsink.aspx.vb" Inherits="etsink" %>
...
<p>
<img src="img/etsink/<%# Eval("pic") %>"  alt ="<%#EVAL("pic") %>" width="400"  style =" border :inset 4px #1d2c53; float:right ;"  />
...
<asp:Label ID="piclbl" runat="server" Text='<%# Eval("pic") %>' Visible ="false"></asp:Label>
<img src="img/etsink/<%# Eval("pic") %>"   alt ="<%#EVAL("pic") %>" width="400"/>
<br />
...
SelectCommand="SELECT * FROM [etsink]"
 UpdateCommand ="UPDATE etsink set body=@body, pic=@pic, keywords=@keywords, title=@title WHERE [key]=@key">
  <UpdateParameters>
